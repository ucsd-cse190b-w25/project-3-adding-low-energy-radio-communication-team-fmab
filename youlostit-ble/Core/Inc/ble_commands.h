...
uint8_t DISCONNECT[] = {0x01,this needs to be something,0x01}; // TODO - fill this in
...
uint8_t ACI_GAP_SET_NON_DISCOVERABLE_COMPLETE[] = {0x04, 0x0e, 0x04}; // TODO - fill this in
